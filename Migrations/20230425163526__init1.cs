        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RechargePlans_Categorys_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RechargePlanId = table.Column<int>(type: "int", nullable: false),
                    RechargedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recharges_RechargePlans_RechargePlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RechargePlans_CategoryId",
                schema: "dbo",
                table: "RechargePlans",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Recharges_RechargePlanId",
                schema: "dbo",
                table: "Recharges",
